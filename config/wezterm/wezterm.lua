...
return {
    ...
    font = wezterm.font_with_fallback({
      -- /usr/share/fonts/JetBrainsMono/JetBrainsMonoNerdFontMono-Regular.ttf, FontConfig
      -- AKA: "JetBrainsMono NFM"
      {family="JetBrainsMono Nerd Font Mono", harfbuzz_features={"calt=1", "clig=1", "liga=1"}},
      -- /usr/share/fonts/JetBrainsMono/JetBrainsMono-Regular.ttf, FontConfig
      "JetBrains Mono",
      -- /usr/share/fonts/noto/NotoColorEmoji.ttf, FontConfig
      -- Assumed to have Emoji Presentation
      -- Pixel sizes: [128]
      "Noto Color Emoji",
      -- /usr/share/fonts/NerdFontsSymbolsOnly/SymbolsNerdFontMono-Regular.ttf, FontConfig
